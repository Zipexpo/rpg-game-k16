...
(function() {
	...
	var gold = String(PluginManager.parameters('ModernMenu')['Show Gold Window']).trim().toLowerCase() === 'true';
	var sv = String(PluginManager.parameters('ModernMenu')['Show SV Window']).trim().toLowerCase() === 'true';
	var bustX = Number(PluginManager.parameters('ModernMenu')['Bust X Pos']);
	var bustY = Number(PluginManager.parameters('ModernMenu')['Bust Y Pos']);
	var bustRows = Number(PluginManager.parameters('ModernMenu')['Bust Window Rows']);
	var bustCols = Number(PluginManager.parameters('ModernMenu')['Bust Window Cols']);
	var bwX = String(PluginManager.parameters('ModernMenu')['Bust Window X']);
	var bwY = String(PluginManager.parameters('ModernMenu')['Bust Window Y']);
	var bwW = String(PluginManager.parameters('ModernMenu')['Bust Window Width']);
	var bwH = String(PluginManager.parameters('ModernMenu')['Bust Window Height']);
	var col = Number(PluginManager.parameters('ModernMenu')['Max Columns']);
	var row = Number(PluginManager.parameters('ModernMenu')['Visible Rows']);
	var mpBar = String(PluginManager.parameters('ModernMenu')['Draw MP Bar']).trim().toLowerCase() === 'true';
	var tpBar = String(PluginManager.parameters('ModernMenu')['Draw TP Bar']).trim().toLowerCase() === 'true';
	var hpWidth = Number(PluginManager.parameters('ModernMenu')['HP Window Width']);
	var batX = String(PluginManager.parameters('ModernMenu')['Battler X Pos']);
	var batY = String(PluginManager.parameters('ModernMenu')['Battler Y Pos']);
	var batXW = String(PluginManager.parameters('ModernMenu')['B. Window X']);
	var batYH = String(PluginManager.parameters('ModernMenu')['B. Window Y']);
	var batW = String(PluginManager.parameters('ModernMenu')['B. Window Width']);
	var batH = String(PluginManager.parameters('ModernMenu')['B. Window Height']);
	var hpX = String(PluginManager.parameters('ModernMenu')['HP Window X']);
	var hpY = String(PluginManager.parameters('ModernMenu')['HP Window Y']);
	var goldX = String(PluginManager.parameters('ModernMenu')['Gold Window X']);
	var goldY = String(PluginManager.parameters('ModernMenu')['Gold Window Y']);
	var comX = String(PluginManager.parameters('ModernMenu')['Command Window X']);
	var comY = String(PluginManager.parameters('ModernMenu')['Command Window Y']);
